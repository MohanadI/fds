...
export class Aggregator {
    ...
    async getMLPredection(hofSeq, subSeq, visitSeq, hospitalDoctorId, hcpId) {
        let pateintFeatures: PatientFeatures =  await this.getPatientFeaturesValues(hofSeq, subSeq, visitSeq);
        let doctorFeatures: DoctorFeatures = await this.getDoctorFeaturesValues(hospitalDoctorId, hcpId);

        //**************************************** Patient Model **************************************** */
        console.log(pateintFeatures);
        // call patient AI api
